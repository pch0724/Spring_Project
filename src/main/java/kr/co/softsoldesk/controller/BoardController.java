...
@Controller
@RequestMapping("/board") // board 경로 전체
public class BoardController {
	...
	public String modify(@RequestParam("board_info_idx") int board_info_idx,
						 ...
						 @ModelAttribute(name = "modifyContentBean") ContentBean modifyContentBean, Model model) {
		...
		modifyContentBean.setContent_idx(content_idx);  //param 값 그대로 가져오기
